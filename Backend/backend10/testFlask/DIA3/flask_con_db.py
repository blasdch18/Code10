...
app = Flask(__name__)
# Cuando tenemos un diccionario poder OBTENER el valor de una de sus llaves con el metodo .get('LLAVE'), SOLO es para
# Obtener , no para asignar . Y si que  al valor otbtener no hay valor entonces colocara None(vacio)
...
#  $ pip freeze > requirements.txt     guarda las librerias

#  $ pip install -r requirements.txt       instalar todo de un solo trip